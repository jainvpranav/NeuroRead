      ...
      <main className="flex-1 container py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Upload and analyze handwriting samples</p>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-3 lg:grid-cols-4">
          <Card className="md:col-span-2 lg:col-span-3 border-none shadow-lg">
            <Tabs defaultValue="upload" className="w-full">
              <CardHeader>
                ...
                <CardDescription>
                  Upload a clear image of the student's handwriting to analyze for dyslexia indicators
                </CardDescription>
              </CardHeader>
                    ...
                    <div className="grid w-full items-center gap-1.5">
                      ...
                      <div
                        className={`flex flex-col items-center justify-center border-2 border-dashed rounded-xl p-12 cursor-pointer transition-all ${
                          previewUrl ? "border-primary/40 bg-primary/5" : "hover:bg-muted/50 hover:border-primary/30"
                        }`}
                        onClick={() => document.getElementById("handwriting")?.click()}
                      >
                        <Input
                          id="handwriting"
                          type="file"
              ...
              <TabsContent value="camera">
                <CardContent className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-sm text-muted-foreground text-center max-w-md mb-6">
                    This feature allows you to take a photo of handwriting directly with your device's camera.
                  </p>
          ...
          <Card className="md:row-span-2 border-none shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Your most recent handwriting analyses</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  {recentAnalyses.map((analysis) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          <h4 className="font-medium">{analysis.studentName}</h4>
                          <p className="text-xs text-muted-foreground">{formatDate(analysis.date)}</p>
                        </div>
                        <Badge
                          className={`${getRiskLevelClass(analysis.results.dyslexiaScore)} hover:${getRiskLevelClass(analysis.results.dyslexiaScore)}`}
                        >
              ...
              <Alert className="bg-primary/5 border-primary/20">
                ...
                <AlertDescription>
                  <ul className="list-disc pl-5 space-y-1 mt-2">
                    ...
                    <li>Ask the student to write a paragraph of at least 3-4 sentences</li>
                    <li>Ensure the writing includes a mix of common and complex words</li>
                    <li>Capture the entire writing process if possible (for writing dynamics)</li>
